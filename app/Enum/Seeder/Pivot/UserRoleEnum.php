...
final class UserRoleEnum{
    ...
    public const USER_BAPTISM_AND_ROLE_BAPTISM= UserEnum::BAPTISM.SEPARATOR_PIVOT. RoleEnum::ROLE_BAPTISM;

    public static function all(){
        return [
            static::USER_SUPER_AND_ROLE_USER,
            static::USER_USER_AND_ROLE_USER,
            static::USER_ROLE_AND_ROLE_ROLE,
            static::USER_PERMISSION_AND_ROLE_PERMISSION
        ];
    }
