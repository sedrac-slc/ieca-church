...
final class PermissionEnum{
    ...
    public const PERMISSION_BAPTISM_VIEW = "PERMISSION_BAPTISM_VIEW";
    public const PERMISSION_BAPTISM_CREATE = "PERMISSION_BAPTISM_CREATE";
    public const PERMISSION_BAPTISM_UPDATE = "PERMISSION_BAPTISM_UPDATE";
    public const PERMISSION_BAPTISM_DELETE = "PERMISSION_BAPTISM_DELETE";
